...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full ">
      ...
      <div className="bg-white px-8 py-8  rounded w-full max-w-4xl max-h-[100vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="doc-img">
            <img
              className="w-15 bg-gray-100 rounded-full cursor-pointer"
