    ...
    <div>
        ...
        <div>
            ...
            {appointments.slice(0,5).map((item,index)=>(
              ...
              <div className='flex-1 test-sm text-zinc-600'>
            ...
            <div className='flex flex-col gap-2 justify-end'>
             ...
             {item.cancelled &&  !item.isCompleted && <button  className='sm:min-w-48 py-2 border border-red-500 text-red-500'> Appointmment cancel</button>}
